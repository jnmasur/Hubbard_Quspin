...
class VisitingDistribution(object):
    ...
    def visiting(self, x, step, temperature):
        ...
        return np.around(x_visit, decimals=4)
    ...
    def visit_fn(self, temperature, dim):
        ...
        return np.around(x / den, decimals=4)
...
class EnergyState(object):
    ...
    def reset(self, func_wrapper, rand_gen, x0=None):
        ...
        """
        if x0 is None:
            self.current_location = np.around(rand_gen.uniform(self.lower, self.upper,
                                                     size=len(self.lower)), decimals=4)
        else:
